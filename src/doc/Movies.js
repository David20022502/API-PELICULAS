...
const Movies= () =>{
    ...
    const showModal = (ide) => {
        ...
        setMovieid(ide);
        //console.log("ide de la peli",ide);
        const commentnew = comment.filter((item,index)=> item.idemovie===ide )

/*
        const commentnew = comment.map((item,inde)=>{
            if(item.idemovie===ide){
                return item;
            ...
            console.log("no esta dentro",ide)
            console.log("no esta dentro2",item.idemovie)

        })*/

        setCommentmovie(commentnew);
       // console.log("comentario",commentnew);
       // console.log("111111111",comment);
    };
    ...
    const onSubmit = (ideMov)=> {
        ...
        //console.log("valor al mandar",ideMov);
    ...
    const searhMovies=()=>{
       ...
       // db.ref("busquedas").push(word);
        setPetition(word);

    }
    /**if(movies==null || info==null){
    ...
    return (
        <>
            ...
            {movies ?  <div className="containerMovies">
                {
